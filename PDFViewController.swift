...
class PDFViewController: UIViewController, UIPageViewControllerDelegate, UIPageViewControllerDataSource, UIScrollViewDelegate {
	...
	// MARK: - Initializer
	convenience init?(fileURL: URL, password: String? = nil, hasCoverPage: Bool = false, layoutMargin: PDFLayoutMargin = PDFLayoutMargin.zero, backgroundColor: UIColor = UIColor.white, pageBackgroundColor: UIColor = UIColor.white) {
